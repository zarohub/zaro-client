...
var _zenttyClient2 = _interopRequireDefault(_zenttyClient);
...
var ZaroClient = function (_ZenttyClient) {
    _inherits(ZaroClient, _ZenttyClient);

    function ZaroClient() {
        _classCallCheck(this, ZaroClient);

        return _possibleConstructorReturn(this, (ZaroClient.__proto__ || Object.getPrototypeOf(ZaroClient)).apply(this, arguments));
    }
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                return this.client.query({
                                    fetchPolicy: 'network-only',
                                    query: (0, _graphqlTag2.default)(_templateObject2),
                                    variables: _extends({}, params)
                                });
    ...
    return ZaroClient;
}(_zenttyClient2.default);

if (typeof window !== 'undefined') {
    window.ZaroClient = ZaroClient;
}

exports.default = ZaroClient;
},{"graphql-tag":342,"zentty-client":379}],2:[function(require,module,exports){
"use strict";
...
var ZaroClient = require('./index');

exports.default = ZaroClient;
},{"./index":1,"babel-core/register":9,"babel-polyfill":10}],3:[function(require,module,exports){
(function (process){
...
},{"_process":365,"apollo-link-core":6,"graphql-anywhere":339,"graphql/language/printer":4,"redux":371,"symbol-observable":374,"whatwg-fetch":377}],4:[function(require,module,exports){
'use strict';
...
},{"./visitor":5}],5:[function(require,module,exports){
'use strict';
...
},{"./link":7,"./linkUtils":8,"zen-observable-ts":378}],7:[function(require,module,exports){
"use strict";
...
},{"./linkUtils":8,"graphql-tag":342,"zen-observable-ts":378}],8:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./link":7}],9:[function(require,module,exports){
/* eslint max-len: 0 */
// TODO: eventually deprecate this console.trace("use the `babel-register` package instead of `babel-core/register`");
module.exports = require("babel-register");

},{"babel-register":11}],10:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":13,"core-js/shim":335,"regenerator-runtime/runtime":373}],11:[function(require,module,exports){
"use strict";
...
},{"./storeUtils":340}],337:[function(require,module,exports){
"use strict";
function checkDocument(doc) {
    if (doc.kind !== 'Document') {
        throw new Error("Expecting a parsed GraphQL document. Perhaps you need to wrap the query string in a \"gql\" tag? http://docs.apollostack.com/apollo-client/core.html#gql");
...
},{"./directives":336,"./getFromAST":337,"./storeUtils":340}],339:[function(require,module,exports){
"use strict";
...
},{"./graphql":338,"./utilities":341}],340:[function(require,module,exports){
"use strict";
var SCALAR_TYPES = {
    StringValue: true,
    BooleanValue: true,
...
},{"./graphql":338}],342:[function(require,module,exports){
(function (global, factory) {
...
},{"graphql/language/parser":352}],343:[function(require,module,exports){
'use strict';
...
},{"../language/location":351}],344:[function(require,module,exports){
'use strict';
...
function formatError(error) {
   ...
   * 
   */
},{"../jsutils/invariant":348}],345:[function(require,module,exports){
'use strict';
...
},{"./GraphQLError":343,"./formatError":344,"./locatedError":346,"./syntaxError":347}],346:[function(require,module,exports){
'use strict';
...
function locatedError(originalError, nodes, path) {
   ...
   * 
   */
},{"./GraphQLError":343}],347:[function(require,module,exports){
'use strict';
...
},{"../language/location":351,"./GraphQLError":343}],348:[function(require,module,exports){
"use strict";
...
},{"../error":345}],351:[function(require,module,exports){
'use strict';
...
},{"../error":345,"./kinds":349,"./lexer":350,"./source":353}],353:[function(require,module,exports){
'use strict';
...
},{"../jsutils/invariant":348}],354:[function(require,module,exports){
...
},{"./_root":362}],356:[function(require,module,exports){
...
},{"./_Symbol":355,"./_getRawTag":359,"./_objectToString":360}],357:[function(require,module,exports){
(function (global){
...
},{"./_overArg":361}],359:[function(require,module,exports){
var Symbol = require('./_Symbol');
...
},{"./_Symbol":355}],360:[function(require,module,exports){
/** Used for built-in method references. */
var objectProto = Object.prototype;
...
},{"./_freeGlobal":357}],363:[function(require,module,exports){
/**
...
},{"./_baseGetTag":356,"./_getPrototype":358,"./isObjectLike":363}],365:[function(require,module,exports){
...
},{"./createStore":370,"./utils/warning":372,"_process":365,"lodash/isPlainObject":364}],369:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":364,"symbol-observable":374}],371:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":366,"./bindActionCreators":367,"./combineReducers":368,"./compose":369,"./createStore":370,"./utils/warning":372,"_process":365}],372:[function(require,module,exports){
'use strict';
...
},{"./lib/index":375}],375:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./ponyfill.js":376}],376:[function(require,module,exports){
'use strict';
...
var _networkInterface = require('./network-interface');
...
var ZenttyClient = function () {
    function ZenttyClient() {
        ...
        this.auth = null;
        if (cfg.sessionCode) {
            this.auth = _base2.default.encode(cfg.sessionCode + ':');
        } else {
    ...
    _createClass(ZenttyClient, [{
        ...
        key: 'setStoredToken',
        value: function setStoredToken(token) {
            try {
                if (typeof localStorage !== 'undefined') {
                    if (token === null) {
        ...
        key: 'setSessionCode',
        value: function setSessionCode(sessionCode) {
            if (sessionCode === null) {
                this.auth = null;
                    ...
                    while (1) {
                        switch (_context8.prev = _context8.next) {
                            ...
                            case 2:
                                ...
                                success = _ref15.data.relateEntity;
                    ...
                    while (1) {
                        switch (_context9.prev = _context9.next) {
                            ...
                            case 2:
                                ...
                                success = _ref17.data.unrelateEntity;
                    ...
                    while (1) {
                        switch (_context10.prev = _context10.next) {
                            case 0:
                                _context10.next = 2;
                                return this.client.query({
                                    query: (0, _graphqlTag2.default)(_templateObject10),
                                    variables: Object.assign({}, params),
                                    fetchPolicy: 'network-only'
                                });
                            ...
                            case 2:
                                ...
                                entities = _ref19.data.getEntities;
                    ...
                    while (1) {
                        switch (_context11.prev = _context11.next) {
                            case 0:
                                _context11.next = 2;
                                return this.client.query({
                                    query: (0, _graphqlTag2.default)(_templateObject11),
                                    variables: Object.assign({}, params),
                                    fetchPolicy: 'network-only'
                                });
                            ...
                            case 2:
                                ...
                                entities = _ref21.data.getRelatedEntities;
                                return _context11.abrupt('return', entities);
        ...
        value: function () {
            var _ref22 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(params) {
                var _ref23, success;
                    ...
                    while (1) {
                        switch (_context12.prev = _context12.next) {
                            case 0:
                                ...
                                return this.client.mutate({
                                    fetchPolicy: 'network-only',
                                    mutation: (0, _graphqlTag2.default)(_templateObject12),
                                    variables: Object.assign({}, params)
                                });

                            case 2:
                                _ref23 = _context12.sent;
                                success = _ref23.data.prepareFileUpload;
            ...
            function prepareFileUpload(_x13) {
        ...
        key: 'appendFileChunk',
        value: function () {
            var _ref24 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(params) {
                var _ref25, isComplete;
                    ...
                    while (1) {
                        switch (_context13.prev = _context13.next) {
                            case 0:
                                ...
                                return this.client.mutate({
                                    fetchPolicy: 'network-only',
                                    mutation: (0, _graphqlTag2.default)(_templateObject13),
                                    variables: {
                            ...
                            case 2:
                                ...
                                isComplete = _ref25.data.appendFileChunk;
                                return _context13.abrupt('return', isComplete);
        ...
        key: 'uploadFile',
        value: function () {
            var _ref27 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(_ref26) {
                var _ref26$entityID = _ref26.entityID,
                    entityID = _ref26$entityID === undefined ? null : _ref26$entityID,
                    _ref26$file = _ref26.file,
                    file = _ref26$file === undefined ? null : _ref26$file;
...
},{"./network-interface":380,"apollo-client":3,"base-64":12,"graphql-tag":342}],380:[function(require,module,exports){
'use strict';
...
var UploadHTTPFetchNetworkInterface = exports.UploadHTTPFetchNetworkInterface = function (_HTTPFetchNetworkInte) {
    ...
    function UploadHTTPFetchNetworkInterface() {
        ...
        return _possibleConstructorReturn(this, (UploadHTTPFetchNetworkInterface.__proto__ || Object.getPrototypeOf(UploadHTTPFetchNetworkInterface)).apply(this, arguments));
    }

    _createClass(UploadHTTPFetchNetworkInterface, [{
        key: 'fetchFromRemoteEndpoint',
        value: function fetchFromRemoteEndpoint(_ref) {
...
}(_apolloClient.HTTPFetchNetworkInterface);

function createNetworkInterface(_ref2) {
    var uri = _ref2.uri,
...
},{"apollo-client":3,"isomorphic-form-data":354}]},{},[2]);
