...
},{"apollo-client":1,"isomorphic-form-data":26}],52:[function(require,module,exports){
'use strict';
...
var ZaroClient = function (_ZenttyClient) {
    ...
    _createClass(ZaroClient, [{
         ...
         * }
         */
        value: function getTeamMembers(params) {
            var _this2 = this;
        ...
        key: 'createTeam',
        value: function createTeam(params) {
            var _this3 = this;
        ...
        value: function inviteTeamMember(params) {
            var _this4 = this;

            return new Promise(function (fulfill, reject) {
                _this4.client.mutate({
...
},{"graphql-tag":12,"zentty-client":50}]},{},[52]);
